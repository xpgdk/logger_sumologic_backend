defmodule LoggerSumologicBackend.Clients.HTTPotionTest do
  ...
  setup do
    ...
    client_id = Clients.HTTPotion.init([
      endpoint: endpoint,
  ...
  test "Log one entry", tags do
    ...
    Clients.HTTPotion.log_event(tags.client_id, [entry])
  end
  ...
  test "Log multiple short entries", tags do
    ...
    Clients.HTTPotion.log_event(tags.client_id, [entry1, entry2])
  end
